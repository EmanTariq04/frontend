  ...
  return (
    <div>
      ...
      <div
        ...
        className="border-2 active:border-black mb-2 rounded-xl flex p-3 w-full items-center justify-between"
      >
        <img
          className="h-20"
        ...
        <h2 className="text-lg font-semibold">$189.08</h2>
      </div>
      <div
        onClick={() => {
          props.setConfirmRidePanel(true);
      ...
      >
        ...
        <h2 className="text-lg font-semibold">$65.08</h2>
      </div>
      <div
        onClick={() => {
          props.setConfirmRidePanel(true);
      ...
      >
        ...
        <h2 className="text-lg font-semibold">$118.08</h2>
      </div>
    </div>
  );
};
